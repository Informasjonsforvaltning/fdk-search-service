...
import no.digdir.fdk.searchservice.model.AssociativeRelation
import no.digdir.fdk.searchservice.model.Collection
import no.digdir.fdk.searchservice.model.Concept
import no.digdir.fdk.searchservice.model.Definition
import no.digdir.fdk.searchservice.model.GenericRelation
...
import no.digdir.fdk.searchservice.model.PartitiveRelation
import no.digdir.fdk.searchservice.model.TextAndURI

// ids start from 20 to avoid conflicts with the ids in the test data for the other types
val TEST_NULL_CONCEPT =
    Concept(
...
val TEST_CONCEPT_HIT_ALL_FIELDS =
