...
fun Dataset.toSearchObject(id: String, timestamp: Long, deleted: Boolean = false) = SearchObject(
    id = id,
    uri = uri,
...
private fun Reference.uriToRelationType(): RelationType? = when (referenceType?.uri) {
...
fun Dataset.getSpecializedType(): SpecializedType? = when (specializedType) {
